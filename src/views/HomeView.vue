<template>
  <div class="home">
    ...
    <div title="Logo" class="logo-svg my-5 mx-auto" />
    <div>
      <h1>Welcome to the INVESABLEAI</h1>
    </div>
    <div>This page allows you to control your trading bot.</div>
    <br />
    <p>
      If you need any help, please refer to the
      <a href="#">Bot Documentation</a>.
    </p>
...
.logo-svg {
  -webkit-mask: url(../assets/invesableai-logo.png) no-repeat center;
  -webkit-mask-size: 240px 240px;
  mask: url(../assets/invesableai-logo.png) no-repeat center;
  mask-size: contain;
  width: 250px;
  height: 250px;
}
